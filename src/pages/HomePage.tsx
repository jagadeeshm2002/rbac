...
import Grid from "@/assets/GridRbac.svg";
    ...
    <div className="w-screen h-screen flex justify-center items-center">
      <div className="flex w-full h-full">
        <div className="w-3/5 relative">
          ...
          >
            <div
              className="absolute z-[1] w-full h-full bg-no-repeat bg-cover opacity-[0.5]"
              style={{ backgroundImage: `url(${Grid})` }}
            ></div>
            <div className="w-full h-full flex flex-col  ">
              <div className="text-white w-full h-32 flex items-center justify-start px-10">
                <img
                  src={Logo}
                  width={50}
                  height={50}
                ...
                />
                <p className="text-4xl font-bold font-mono">VRV Security</p>
              </div>
              <div className="w-full h-full flex justify-center items-center flex-col ">
                <div className="z-[3]  ">
                  ...
                  >
                    <path
                      className=" animate-suble-Bounce "
                      d="M130.675 173.652C96.4893 177.322 93.508 180.303 89.8377 214.489C86.1674 180.303 83.1861 177.322 49 173.652C83.1861 169.981 86.1674 167 89.8377 132.814C93.508 167 96.4893 169.981 130.675 173.652Z"
                      fill="url(#paint0_linear_4020_392)"
                    />
                    <path
                      className=" animate-suble-Bounce "
                      d="M158.224 108.19C142.165 109.92 140.772 111.312 139.043 127.372C137.313 111.312 135.921 109.92 119.861 108.19C135.921 106.461 137.313 105.068 139.043 89.009C140.772 105.068 142.165 106.461 158.224 108.19Z"
                      fill="url(#paint1_linear_4020_392)"
                    />
                    <path
                      className=" animate-suble-Bounce "
                      d="M566.022 527.683H193.068C188.723 527.683 185.179 524.139 185.179 519.794V253.786C185.179 249.441 188.723 245.897 193.068 245.897H566.022C570.367 245.897 573.911 249.441 573.911 253.786V519.779C573.911 524.139 570.367 527.669 566.022 527.669V527.683ZM193.068 246.713C189.173 246.713 185.995 249.877 185.995 253.786V519.779C185.995 523.675 189.159 526.853 193.068 526.853H566.022C569.917 526.853 573.095 523.675 573.095 519.779V253.786C573.095 249.891 569.931 246.713 566.022 246.713H193.068Z"
                      fill="#FDFEFE"
                    />
                    <path
                      className=" animate-suble-Bounce "
                      d="M561.072 534.278H188.119C183.773 534.278 180.229 530.734 180.229 526.389V260.382C180.229 256.036 183.773 252.492 188.119 252.492H561.072C565.417 252.492 568.961 256.036 568.961 260.382V526.375C568.961 530.72 565.417 534.264 561.072 534.264V534.278ZM188.119 253.308C184.223 253.308 181.045 256.472 181.045 260.382V526.375C181.045 530.27 184.209 533.448 188.119 533.448H561.072C564.967 533.448 568.145 530.284 568.145 526.375V260.382C568.145 256.486 564.981 253.308 561.072 253.308H188.119Z"
                      fill="#FDFEFE"
                    />
                    <path
                      className=" animate-suble-Bounce "
                      d="M556.122 540.874H183.183C178.837 540.874 175.293 537.33 175.293 532.984V266.977C175.293 262.632 178.837 259.088 183.183 259.088H556.136C560.481 259.088 564.025 262.632 564.025 266.977V532.97C564.025 537.316 560.481 540.86 556.136 540.86L556.122 540.874ZM183.183 259.904C179.287 259.904 176.109 263.068 176.109 266.977V532.97C176.109 536.866 179.273 540.044 183.183 540.044H556.136C560.031 540.044 563.209 536.88 563.209 532.97V266.977C563.209 263.082 560.045 259.904 556.136 259.904H183.183Z"
                      fill="#FDFEFE"
                    />
                    <path
                      className=" animate-suble-Bounce "
                      d="M563.617 292.008H175.701V292.838H563.617V292.008Z"
                      fill="#FDFEFE"
                    />
                    <path
                      className=" animate-pulse"
                      d="M535.169 280.21C537.801 280.21 539.936 278.075 539.936 275.443C539.936 272.81 537.801 270.675 535.169 270.675C532.536 270.675 530.401 272.81 530.401 275.443C530.401 278.075 532.536 280.21 535.169 280.21Z"
                      fill="url(#paint2_linear_4020_392)"
                    />
                    <path
                      className="animate-pulse"
                      d="M519.01 280.21C521.643 280.21 523.778 278.075 523.778 275.443C523.778 272.81 521.643 270.675 519.01 270.675C516.377 270.675 514.243 272.81 514.243 275.443C514.243 278.075 516.377 280.21 519.01 280.21Z"
                      fill="url(#paint3_linear_4020_392)"
                    />
                    <path
                      className="animate-pulse"
                      d="M502.853 280.21C505.485 280.21 507.62 278.075 507.62 275.443C507.62 272.81 505.485 270.675 502.853 270.675C500.22 270.675 498.085 272.81 498.085 275.443C498.085 278.075 500.22 280.21 502.853 280.21Z"
                      fill="url(#paint4_linear_4020_392)"
                    />
                    <path
                      className="antialiased "
                      d="M214.879 477.409C197.147 480.348 179.203 482.219 161.189 482.275C152.189 482.275 143.174 481.797 134.231 480.615C129.759 480.011 125.315 479.195 120.913 478.197C116.512 477.142 112.166 475.862 107.92 474.273C99.4539 471.095 91.3398 466.469 84.9273 459.887C81.7351 456.597 79.021 452.814 77.01 448.679C76.4757 447.653 76.1382 446.556 75.7022 445.487C75.3225 444.404 74.7741 443.364 74.535 442.239L73.7194 438.892C73.5928 438.329 73.41 437.781 73.3397 437.204L73.1428 435.489C71.9616 426.348 73.4381 417.095 76.2647 408.46C79.1054 399.798 83.2397 391.656 87.9507 383.921C90.257 380.012 92.8867 376.327 95.4601 372.601C98.1742 368.987 100.86 365.331 103.771 361.885C106.57 358.327 109.663 355.037 112.631 351.62L117.285 346.698C118.832 345.052 120.393 343.421 122.01 341.846C134.793 329.091 148.434 317.251 162.735 306.254C191.311 284.246 222.009 265.135 253.861 248.288C285.783 231.567 318.844 217.055 352.861 205.13C369.863 199.181 387.118 193.908 404.583 189.45C422.049 184.978 439.74 181.392 457.599 178.931C462.057 178.256 466.557 177.863 471.029 177.3C475.529 176.948 480.015 176.428 484.515 176.245C493.515 175.627 502.557 175.613 511.571 175.894C520.6 176.259 529.6 177.23 538.487 178.945C547.347 180.689 556.136 183.248 564.264 187.327C572.35 191.391 579.803 197.142 584.936 204.708C590.223 212.203 592.361 221.541 592.122 230.541C591.826 239.625 589.267 248.428 585.766 256.711C582.165 264.966 577.623 272.771 572.533 280.182C577.511 272.7 581.941 264.839 585.4 256.557C588.775 248.26 591.166 239.471 591.32 230.527C591.419 221.653 589.183 212.597 583.937 205.397C578.833 198.127 571.52 192.642 563.547 188.775C555.545 184.88 546.897 182.405 538.136 180.773C529.361 179.156 520.445 178.256 511.501 177.975C502.557 177.778 493.599 177.848 484.67 178.552C480.198 178.777 475.754 179.339 471.282 179.719C466.838 180.309 462.381 180.745 457.951 181.448C422.485 186.736 387.68 196.031 353.86 207.956C320.039 219.91 287.133 234.478 255.408 251.199C223.669 267.877 193.054 286.833 164.578 308.63C150.332 319.515 136.748 331.243 124.049 343.857C122.432 345.404 120.885 347.021 119.352 348.652L114.74 353.518C111.787 356.879 108.735 360.156 105.937 363.629C103.026 367.018 100.354 370.604 97.6398 374.148C95.0804 377.79 92.4507 381.418 90.1585 385.229C85.4616 392.795 81.3413 400.754 78.5147 409.164C75.6882 417.545 74.1975 426.461 75.2663 435.207L75.435 436.853C75.4913 437.401 75.6741 437.922 75.7725 438.456L76.5319 441.662C76.7428 442.745 77.2632 443.729 77.6147 444.756C78.0225 445.768 78.346 446.837 78.8382 447.808C80.7226 451.773 83.2819 455.401 86.3195 458.579C92.4226 464.964 100.284 469.52 108.566 472.755C112.715 474.386 116.976 475.708 121.307 476.819C125.652 477.873 130.04 478.745 134.47 479.42C143.329 480.728 152.301 481.347 161.273 481.473C179.231 481.684 197.189 480.081 214.95 477.409H214.879Z"
                      fill="url(#paint5_linear_4020_392)"
                    />
                    <mask
                      id="mask0_4020_392"
              ...
              <div className="w-full h-32 flex items-center justify-end">
                <p className="text-xl text-right w-full pr-10 font-bold text-white z-[2] font-space-mono">
                  signin to continue access...
                </p>
              </div>
            </div>
          </div>
